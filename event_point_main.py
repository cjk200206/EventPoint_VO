...
if __name__ == '__main__':
    ...
    parser.add_argument('--event_file', type=str,default="/home/cjk2002/datasets/VECTOR/corridors_dolly1.synced.left_event.hdf5", help='Path to events.h5 file')
    parser.add_argument('--pose_file', type=str,default="/home/cjk2002/datasets/VECTOR/corridors_dolly1.synced.gt.txt", help='Path to pose file')
