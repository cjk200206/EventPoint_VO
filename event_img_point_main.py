...
if __name__ == '__main__':
    ...
    cam_vector = PinholeCamera(1224,1024,886.19107,886.59163,610.57891,514.59271)
    ...
    for index in range(int(len(img_list)/3)):
        # p = events['p']
        # x = events['x']
        # y = events['y']
        # t = events['t']
        ...
        ##普通的img
        try:
            img_train_path = img_list[img_id*3]
        except:
        ...
        norm_draw_x, norm_draw_y = int(x*5) + 500, int(z*5) + 500
        true_x, true_y = int(vo.trueX*5) + 500, int(vo.trueY*5) + 500
